...
export const sidebar = {
  ...
  clearButton:
    "w-full px-[7px] py-[3px] bg-white border border-[#c12120] rounded-[3px] text-[#c12120] text-[10px] font-bold cursor-pointer transition-all duration-150 uppercase hover:bg-[#c12120] hover:text-white",
};
