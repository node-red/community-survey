        ...
        <div className="p-4 relative overflow-hidden">
          ...
          {data.length > 0 && (
            <table className="sr-only">
              <caption>{questionTitle || 'Geographic distribution'} data</caption>
              <thead>
                <tr>
              ...
              <tbody>
                {geographies
                  .filter(geo => {
                    const countryCode = String(geo.id);
                    return dataMap[countryCode] && dataMap[countryCode].count > 0;
                  })
                  .sort((a, b) => {
                    const countA = dataMap[String(a.id)]?.count || 0;
                    const countB = dataMap[String(b.id)]?.count || 0;
                  ...
                  .map(geo => {
                    ...
                    return (
                      <tr key={countryCode}>
                        <td>{countryName}</td>
                        <td>{countryData.count} respondents</td>
