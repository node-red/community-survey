...
export const ratingSchemes = {
  ...
  // Bold schemes for binary/simple questions
  sage_bold: [
    "#87A96B", // Sage green for Yes
    "#D46B47", // Terracotta for No
  ],
};
...
export function getRatingScheme(questionId) {
  const questionSchemeMap = {
    ...
    // Stay involved (binary question - use bold colors)
    joRzJE: "sage_bold", // Would you like to stay involved?
  };
